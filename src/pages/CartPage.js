...
const stripePromise = loadStripe("pk_test_51OXGwxSGkCG5I1geNeSTPAzrpos9U2XAa6daFaUX6iF8Q8tLAYxqgYkG2rb5FWKXjMnGTECOOllxUGDFVVegFdV900NYQiCJzV");
                                    ...
                                    {cart.map((item) => (
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src={item.pictures[0].url} style={{ width: "100px", height: "100px", objectFit: "cover" }} alt=""/>
                                            </td>
                                            <td>${item.price}</td>
                                            <td>
